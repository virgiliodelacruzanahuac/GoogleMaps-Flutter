...
class MyMapsState extends State<MyMaps>{
  ...
  List<MarkerId>listMarkerIds=List();
      ...
      body: Container(
        child: GoogleMap(initialCameraPosition: _kGooglePlex,
          ...
          onMapCreated: (GoogleMapController controler){
            ...
            Marker marker1=Marker(markerId: markerId1,position: LatLng(17.4435, 78.3772),
            ...
            Marker marker2=Marker(markerId: markerId2,position: LatLng(17.4837, 78.3158), icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueGreen),);
            Marker marker3=Marker(markerId: markerId3,position: LatLng(17.5169, 78.3428),infoWindow: InfoWindow(
